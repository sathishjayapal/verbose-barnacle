...
public class RepositoriesResourceTest extends BaseIT {
    ...
    void getAllRepositoriess_filtered() {
        RestAssured.given()
                ...
                .accept(ContentType.JSON)
                .when()
                .get("/api/repositories?filter=1001")
                .then()
                .statusCode(HttpStatus.OK.value())
